...
class DroppedCallVerificationVm extends AppViewModel {
  ...
  Future<void> _createOtp() async {
    ...
    final createOtp = await _repo.createDroppedCallOtp(
      country: _country,
      phone: _phone,
    );
  ...
  void triggerCall() {
    _urlLauncherService.openLink(Uri.parse('tel:$receiverNumber'));
  }
}
